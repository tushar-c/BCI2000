////////////////////////////////////////////////////////////////////////////////
// $Id: MainWindow.cpp 3798 2012-02-01 18:07:06Z mellinger $
...
MainWindow::ExecuteCommand( const char* inCommand, const char* inWorkingDir )
{
  ...
  BOOL result = ::CreateProcessA(
      ...
      HIGH_PRIORITY_CLASS | CREATE_NEW_CONSOLE, NULL, inWorkingDir,
      &si, &pi
  );
  delete[] command;
#else // _WIN32
  ...
  if( !result )
  {
    ui->statusEdit->append( OSError().Message() );
    ui->statusEdit->repaint();
  }
  return result;
}

////////////////////////////////////////////////////////////////////////////////
// $Id: DemoWindow.cpp 3798 2012-02-01 18:07:06Z mellinger $
  ...
  mCount( 0 )
{
  ...
  this->setWindowTitle( "3D Environment Demo" );
  this->resize( 640, 480 );

  // Don't erase the GraphDisplay's background
...
DemoWindow::resizeEvent( QResizeEvent* )
{
  ...
  {
    { this, 0 },
    { 0, 0, this->contentsRect().width(), this->contentsRect().height() }
  };
